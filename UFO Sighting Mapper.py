...
def beginning():
    global question
    print(" \nYou can search by 'city' or 'shape' or 'date'") #Maybe date later but that's beta
    question = input("How would you like to search for UFO's? \n ")

    if(question == 'city' or question == 'City' or question == 'CITY'):
        citysearch()

    elif(question == 'shape' or question == 'Shape' or question == 'SHAPE' or question == 'date' or question == 'Date'):
        advancedsearch()
...
def advancedsearch():
    searcher = 0
    global question
    if(question == 'Shape' or question == 'shape'):
        ...
        print("The possible shapes are 'Chevron', 'Cigar', 'Circle', 'Cone', 'Cross', 'Cylinder', 'Diamond', 'Disk', 'Unknown'")
        print("'Egg', 'Fireball', 'Formation', 'Light', 'Other', 'Oval', 'Rectangle', 'Sphere', 'Triangle'")
    ...
    if(question == 'date' or question == 'Date'):
        ...
        print("When searching for the date only put in the month and the day.")
        searchformonth = input("What Month? Ex: If it is January type in 1 \n")
        searchforday = input("What day? Ex: If it is the 1st type in 1 \n")
        dash = '/' #for the string
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    if(searcher == 0):
        print("Sorry nothing was found. Try again.")
        advancedsearch()
